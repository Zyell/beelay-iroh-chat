...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <div class="connection-screen h-full flex items-center justify-center p-6">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm font-mono" style="word-break: break-word; overflow-wrap: break-word; hyphens: auto; max-width: 100%; white-space: normal;">{ move || this_nodes_ticket.get() }</p>
                </div>
